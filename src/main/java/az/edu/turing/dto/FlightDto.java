...
public class FlightDto {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.getId() && numberOfSeats == that.getNumberOfSeats() && origin == that.getOrigin() && destination == that.getDestination() && Objects.equals(departureTime, that.getDepartureTime());
    }
